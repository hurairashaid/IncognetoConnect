...
const ResolveIssue = () => {
  ...
  return (
    <>
      <h1 className='text-2xl font-mono'>Issues Forwarded To Vice Chancellor Samreen Ali</h1>
      <Box>
        {
          issues?.map((e, i) => {
            return (
              <Box key={i}>
                  ...
                  <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column", border: "2px solid black", padding: 10, textAlign: "center", mt: 5 }}>
                    ...
                    <Typography ><strong>Creator:</strong> {e?.creator}</Typography>
                    <Typography ><strong>permitted by:</strong> {e?.permittedBy}</Typography>
